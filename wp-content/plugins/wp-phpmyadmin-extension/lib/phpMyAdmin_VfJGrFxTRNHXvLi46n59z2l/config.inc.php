...
$cfg['blowfish_secret']					= '!SGP+ReJv(VRCT(4b\':!O9OF5.vlpjzR' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_VfJGrFxTRNHXvLi46n59z2l/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://localhost:8000/wp-admin/?rand=7634504&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://localhost:8000/wp-admin/?rand=26347411&pma_logout=1';
